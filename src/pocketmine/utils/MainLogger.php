...
class MainLogger extends \AttachableThreadedLogger{
	...
	public function emergency($message, $name = "緊急事態"){
		$this->send($message, \LogLevel::EMERGENCY, $name, TextFormat::RED);
	}

	public function alert($message, $name = "警報"){
	...
	public function error($message, $name = "錯誤"){
	...
	public function info($message, $name = "執行中的內容"){
		$this->send($message, \LogLevel::INFO, $name, TextFormat::WHITE);
	}

	public function debug($message, $name = "除錯"){
	...
	protected function send($message, $level, $prefix, $color){
		...
		if($thread === null){
			...
			$threadName = $thread->getThreadName() . " 星童";
		}else{
			$threadName = (new \ReflectionClass($thread))->getShortName() . " 星童";
		}
